...
<body2>
    <header>
        <h1>La Dorada</h1>
        <!--<img src="Images/logofeliz.png" align ="right" width = "55" height = "55"/> -->
    ...
    <form method="post" action="Contactodist.php" class="formulario">
        <h1 class="formulario__titulo">Contácto Distribuidores</h1>
...
$registrar = new distribuidoresC();
$registrar->IngresoDistribuidoresC();
